...
function plugin_menu() {
    ...
    add_menu_page("Plugin", "My Plugin","MyPlugin","manage_options", "./icons/Circle-icons-contacts.svg.png");

    // add_menu_page("Plugin", "My Plugin","manage_options", "MyPlugin", "addMessage","./icons/Circle-icons-contacts.svg.png'));
